...
class CSSStyleDeclarationPropertyManager {
    ...
    get(name) {
        ...
        switch (name) {
            ...
            case 'outline':
                return CSSStyleDeclarationPropertyGetParser_1.default.getOutline(this.properties);
            case 'background':
    ...
    set(name, value, important) {
        ...
        switch (name) {
            ...
            case 'border-collapse':
                ...
                break;
            case 'outline':
                properties = CSSStyleDeclarationPropertySetParser_1.default.getOutline(value, important);
                break;
            case 'outline-width':
                properties = CSSStyleDeclarationPropertySetParser_1.default.getOutlineWidth(value, important);
                break;
            case 'outline-style':
                properties = CSSStyleDeclarationPropertySetParser_1.default.getOutlineStyle(value, important);
                break;
            case 'outline-color':
                properties = CSSStyleDeclarationPropertySetParser_1.default.getOutlineColor(value, important);
                break;
            case 'letter-spacing':
                properties = CSSStyleDeclarationPropertySetParser_1.default.getLetterSpacing(value, important);
                break;
            case 'word-spacing':
                properties = CSSStyleDeclarationPropertySetParser_1.default.getWordSpacing(value, important);
                break;
            case 'clear':
            ...
            case 'width':
                ...
                break;
            case 'height':
                properties = CSSStyleDeclarationPropertySetParser_1.default.getHeight(value, important);
                break;
            case 'top':
            ...
            case 'line-height':
                ...
                break;
            case 'text-indent':
                properties = CSSStyleDeclarationPropertySetParser_1.default.getTextIndent(value, important);
                break;
            case 'font-family':
