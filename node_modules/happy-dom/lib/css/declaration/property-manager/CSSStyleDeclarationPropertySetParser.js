...
class CSSStyleDeclarationPropertySetParser {
    ...
    static getLetterSpacing(value, important) {
        const parsedValue = CSSStyleDeclarationValueParser_1.default.getVariable(value) ||
            CSSStyleDeclarationValueParser_1.default.getGlobal(value) ||
    ...
    static getOutlineColor(value, important) {
        const color = CSSStyleDeclarationValueParser_1.default.getVariable(value) ||
            CSSStyleDeclarationValueParser_1.default.getGlobal(value) ||
