...
class CSSStyleDeclarationPropertyGetParser {
    ...
    static getOutline(properties) {
        ...
        if (CSSStyleDeclarationValueParser_1.default.getGlobalExceptInitial(properties['outline-width'].value) &&
        ...
        const values = [];
        if (!CSSStyleDeclarationValueParser_1.default.getInitial(properties['outline-color']?.value)) {
            values.push(properties['outline-color'].value);
        }
        if (!CSSStyleDeclarationValueParser_1.default.getInitial(properties['outline-style']?.value)) {
            values.push(properties['outline-style'].value);
        }
        if (!CSSStyleDeclarationValueParser_1.default.getInitial(properties['outline-width'].value)) {
