...
class Window extends EventTarget_1.default {
    ...
    getComputedStyle(element) {
        element['_computedStyle'] = element['_computedStyle'] || new CSSStyleDeclaration_1.default(element, true);
    ...
    matchMedia(mediaQueryString) {
        return new MediaQueryList_1.default({ ownerWindow: this, media: mediaQueryString });
    }
    /**
