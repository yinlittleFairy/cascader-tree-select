...
class Document extends Node_1.default {
     ...
     */
    get title() {
        const element = ParentNodeUtility_1.default.getElementByTagName(this, 'title');
        if (element) {
     ...
     */
    get baseURI() {
        const element = ParentNodeUtility_1.default.getElementByTagName(this, 'base');
        if (element) {
            return element.href;
        }
     ...
     */
    write(html) {
        const root = XMLParser_1.default.parse(this, html, { evaluateScripts: true });
        if (this._isFirstWrite || this._isFirstWriteAfterOpen) {
            ...
            for (const node of root.childNodes) {
                ...
                else if (node.nodeType === NodeTypeEnum_1.default.documentTypeNode) {
            ...
            if (documentElement) {
                if (!this.documentElement) {
                    ...
                    const rootBody = ParentNodeUtility_1.default.getElementByTagName(root, 'body');
                    const body = ParentNodeUtility_1.default.getElementByTagName(this, 'body');
                    if (rootBody && body) {
                ...
                if (body) {
                    for (const child of root.childNodes.slice()) {
                        if (child['tagName'] !== 'HTML' && child.nodeType !== NodeTypeEnum_1.default.documentTypeNode) {
                            body.appendChild(child);
                        }
                    }
                }
            ...
            const bodyNode = ParentNodeUtility_1.default.getElementByTagName(root, 'body');
            const body = ParentNodeUtility_1.default.getElementByTagName(this, 'body');
