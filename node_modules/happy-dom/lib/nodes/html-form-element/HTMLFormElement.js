...
const HTMLFormControlsCollection_1 = __importDefault(require("./HTMLFormControlsCollection"));
/**
 * HTML Form Element.
 *
 * Reference:
...
class HTMLFormElement extends HTMLElement_1.default {
    constructor() {
        super(...arguments);
        // Public properties.
        this.elements = new HTMLFormControlsCollection_1.default();
        this.length = 0;
        // Events
    ...
    requestSubmit(submitter) {
        ...
        if (noValidate || this.checkValidity()) {
            this.dispatchEvent(new SubmitEvent_1.default('submit', { bubbles: true, cancelable: true, submitter: submitter || this }));
        }
    }
    /**
     * Resets form.
    ...
    reset() {
        ...
        this.dispatchEvent(new Event_1.default('reset', { bubbles: true, cancelable: true }));
    }
    /**
     * Checks validity.
     *
