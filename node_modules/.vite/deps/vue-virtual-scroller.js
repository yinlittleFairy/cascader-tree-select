...
function install(Vue2) {
  Vue2.component("resize-observer", ResizeObserver2);
  Vue2.component("ResizeObserver", ResizeObserver2);
}
var plugin = {
...
var script$2 = {
  ...
  methods: {
    ...
    getListenerTarget() {
      let target = (0, import_scrollparent.default)(this.$el);
    ...
    scrollToPosition(position) {
      ...
      let scrollDistance;
      if (this.pageMode) {
        const viewportEl = (0, import_scrollparent.default)(this.$el);
...
var GlobalVue3 = null;
if (typeof window !== "undefined") {
  GlobalVue3 = window.Vue;
} else if (typeof global !== "undefined") {
  GlobalVue3 = global.Vue;
}
if (GlobalVue3) {
  GlobalVue3.use(plugin3);
}
export {
  __vue_component__$1 as DynamicScroller,
  __vue_component__ as DynamicScrollerItem,
  IdState,
  __vue_component__$2 as RecycleScroller,
  plugin3 as default
};
